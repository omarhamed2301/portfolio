        ...
        <div className="mainContainer">
            ...
            <ul className='links'>
                <li className='nav-link linkedIn'>
                    <a href="https://www.linkedin.com/in/omar-hamed-69b084246/" target='_blank'><FaLinkedin className='LinkedInIcon'/></a>
                </li>
                <li className='nav-link Gmail'><a href="mailto:omarhamed5500@gmail.com"><FaGoogle className='GmailIcon'/></a></li>
                <li className='nav-link btn CV'><a href={PDF} target='_blank'>Download CV</a></li>
            </ul>
        </div>
    </div>    
)
